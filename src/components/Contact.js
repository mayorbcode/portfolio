    ...
    <div className="contact">
      ...
      <div className="middle">
        <a href="https://www.linkedin.com/in/patrick-bello-6796521b3/" target="_blank" rel="noreferrer">
          ...
          <img style={{transitionDelay: '0.6s'}} src="https://img.icons8.com/color/64/000000/linkedin.png" alt="linkedin logo"/>
        </a>
        <a href="https://github.com/mayorbcode" target="_blank" rel="noreferrer">
          <p className="text">GitHub</p>
          <img style={{transitionDelay: '0.65s'}} src="https://img.icons8.com/fluent/64/000000/github.png" alt="github logo"/>
        </a>
        <a href="https://codepen.io/mayorbcode" target="_blank" rel="noreferrer">
          <p className="text">Codepen</p>
          <img style={{transitionDelay: '0.7s'}} src="https://img.icons8.com/material/64/ffffff/codepen.png" alt="codepen logo"/>
        </a>
      </div>
